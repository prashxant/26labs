...
export const Socials = () => {
  return (
    <div className="flex flex-col mt-6 md:mt-8 lg:mt-10 pb-6 md:pb-8 lg:pb-10 px-4">
      <Descripton
        className="max-w-2xl mt-4 md:mt-6 lg:mt-8 mb-3 md:mb-4 text-gray-500"
...
We lead you from design to product innovation to shape your path from idea to success"
      ...
      <div className="flex flex-col gap-y-3 md:gap-y-4 md:flex-row md:items-center md:justify-between text-xs md:text-sm text-neutral-500 mt-4">
