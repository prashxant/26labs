  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          // Cache progress value to avoid repeated property access
          ...
          const yOffset = Math.sin(progress * frequency) * amplitude;
      ...
      >
        ...
        <Point x={1150} y={330}>
          <div className="w-75 font-bold text-gray-600">
            ...
            is a health-tech project that runs on an in-house server hosted in
            our lab.
          </div>
        </Point>
        ...
        <Point x={2340} y={490}>
          <div className="w-76 font-bold text-gray-600">
            It&apos;s a tax and financial services software platform made for
            Simplifying tax management and financial guidance for individuals
            and businesses.
          </div>
        </Point>
        ...
        <Point x={4100} y={340}>
          <PhotoCard
            src="/HorizontalScroll/Project 4.svg"
            width={520}
            height={420}
          />
        </Point>
          ...
          <div className="relative w-140">
            <div className="absolute -top-21 left-1 px-5 py-3 font-semibold rounded-xl z-20">
              <p className="text-md font-semibold leading-snug">
                <span className="text-orange2">Finta</span> is a startup-focused
        ...
        <Point x={5200} y={590}>
          <PhotoCard
            src="/HorizontalScroll/Mockup Scene 52.png"
            width={420}
            height={320}
          />
        </Point>
        <Point x={5520} y={590}>
          <PhotoCard
            src="/HorizontalScroll/Frame 18.png"
            width={290}
            height={150}
          />
        </Point>
        ...
        <Point x={5690} y={510}>
          <div className="relative w-140">
            <div className="absolute -top-21 left-1 px-5 py-3 font-semibold rounded-xl z-20">
              <p className="text-orange2 text-md mt-1">GlobeWork</p>
              <p className="text-md font-semibold text-gray-700 leading-snug">
        ...
        <Point x={6500} y={360}>
          <PhotoCard
            src="/HorizontalScroll/Group 109.png"
            width={490}
            height={390}
          />
        </Point>
        <Point x={6890} y={290}>
          <div className="relative w-140">
            <div className="absolute -top-21 left-1 px-5 py-3 font-semibold rounded-xl z-20">
              <p className="text-md font-semibold leading-snug">
                <span className="text-orange2">Boogymen</span> is a seamless
                solution for
                <br />
        ...
        <Point x={7800} y={620}>
          <PhotoCard
            src="/HorizontalScroll/Frame 201.png"
            width={290}
            height={190}
          />
        </Point>
        <Point x={8070} y={550}>
          <PhotoCard
            src="/HorizontalScroll/Rectangle666.png"
            width={490}
            height={390}
          />
        </Point>
        <Point x={7850} y={500}>
          <div className="relative w-140">
            <div className="absolute -top-21 left-1 px-5 py-3 font-semibold rounded-xl z-20">
              <p className="text-md font-semibold leading-snug">
                <span className="text-orange2">TWNTY1</span> Closet is our own
