...
const Growth = () => {
  return (
    ...
    <span className="relative text-yellow-400 font-medium">
      Define
    </span>
  </div>   
        <div className="relative">
    ...
    <span className="relative text-blue-500 font-medium">
      Deliver
    </span>
  </div>
      </div>
      ...
      <div className="flex justify-center items-center gap-3 mb-8">
        <span className="text-md  text-blue-400">Consultancy Fees</span>
        <span className="px-7 py-1 rounded-[3px] bg-blue-400 border border-blue-800 text-white text-sm font-semibold">
          149 $
        </span>
      </div>
